...
import { InCircle, Mesh } from '@hiber3d/hdk-react-components';
 ...
 */
const Platform = () => (
  <Animation animation={{ x: [-6, 3], y: [-9, 0], duration: 3 }}>
...
const World = () => (
  <HNode y={-1}>
    ...
    <Sign
      ...
      y={2}
    />
    <Mesh y={4} id="en_p_car_01" material="palette_01_cerulean" physical />
    <SpawnPoint rotY={-80} y={20} x={-10} z={4} />
  </HNode>
);
